export const addresses = {
  tenderFactory: process.env.NEXT_PUBLIC_TENDER_FACTORY_ADDRESS as `0x${string}` | undefined,
  tenderToken: process.env.NEXT_PUBLIC_TENDER_TOKEN_ADDRESS as `0x${string}` | undefined,
