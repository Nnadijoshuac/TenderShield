    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-12">
        <div className="flex items-center gap-2 mb-3">
          <Plus className="w-5 h-5 text-[#FFD208]" />
          <span className="text-xs font-semibold text-[#FFD208] uppercase tracking-widest">Start Procurement</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-12">
          <div className="flex gap-3">
            <Lock className="w-6 h-6 text-[#FFD208] flex-shrink-0" />
            <div>
          ...
          <div className="flex gap-3">
            <Users className="w-6 h-6 text-[#FFD208] flex-shrink-0" />
            <div>
          ...
          <div className="flex gap-3">
            <CheckCircle className="w-6 h-6 text-[#FFD208] flex-shrink-0" />
            <div>
